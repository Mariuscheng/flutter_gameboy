...
SET(cargokit_cmake_dir "${CMAKE_CURRENT_LIST_DIR}")
...
if(WIN32)
    ...
    execute_process(COMMAND powershell.exe -ExecutionPolicy Bypass -File "${CMAKE_CURRENT_LIST_DIR}/resolve_symlinks.ps1" "${cargokit_cmake_root}" OUTPUT_VARIABLE cargokit_cmake_root OUTPUT_STRIP_TRAILING_WHITESPACE)
endif()
...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    get_filename_component(CARGOKIT_BUILD_TOOL "${cargokit_cmake_dir}/../run_build_tool${SCRIPT_EXTENSION}" ABSOLUTE)
    file(TO_CMAKE_PATH "${CARGOKIT_BUILD_TOOL}" CARGOKIT_BUILD_TOOL)

    if (NOT WIN32)
        execute_process(COMMAND chmod +x "${CARGOKIT_BUILD_TOOL}")
    endif()
    ...
    if (CMAKE_CONFIGURATION_TYPES AND ${CMAKE_VERSION} VERSION_LESS "3.20.0")
        foreach(CONFIG IN LISTS CMAKE_CONFIGURATION_TYPES)
            add_custom_command(
                ...
                "${CARGOKIT_BUILD_TOOL}" build-cmake
                VERBATIM
            )
        endforeach()
    else()
    ...
    set_property(SOURCE ${OUTPUT_LIB} PROPERTY SYMBOLIC 1)
