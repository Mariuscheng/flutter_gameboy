...
class AndroidEnvironment {
  ...
  Future<Map<String, String>> buildEnvironment() async {
    ...
    final linkerWrapperName =
        '${_androidClangTriple(target)}$minSdkVersion-clang${Platform.isWindows ? '.cmd' : ''}';
    final linkerValue = path.join(toolchainPath, linkerWrapperName);
  ...
  String _androidClangTriple(Target target) {
